      ...
      <div className="relative z-[5] px-5 pb-6 pt-14 sm:px-8 sm:pb-8 sm:pt-20 lg:px-12 lg:pb-12 xl:pb-0 xl:pt-0">
        <div className="flex flex-col gap-10 xl:min-h-[calc(100svh-104px)] xl:flex-row xl:items-center xl:justify-between">
          <section className="w-full sm:w-[520px] lg:w-[620px]" aria-labelledby="age-title">
            <AnimatedElement direction="right" delay={300}><div className="relative flex h-[420px] w-full items-center justify-center overflow-visible sm:h-[500px] lg:h-[550px] xl:h-[450px]">
              <div className="pointer-events-none absolute left-1/2 top-1/2 aspect-square w-[108%] -translate-x-1/2 -translate-y-1/2" aria-hidden="true"><div className="animate-spin-bg absolute inset-0 bg-contain bg-center bg-no-repeat" style={{ backgroundImage: `url(${ageTexture})` }} /></div><div className="age-glow absolute inset-0" />
